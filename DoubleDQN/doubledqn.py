...
env = envs.make("BreakoutNoFrameskip-v4", render_mode='human')
...
def create_q_model(input_shape, number_actions):
...
model = create_q_model(input_shape, actions_number)
# Build a target model for the prediction of future rewards.
# The weights of a target model get updated every 10000 steps thus when the
# loss between the Q-values is calculated the target Q-value is stable.
model_target = create_q_model(input_shape, actions_number)
